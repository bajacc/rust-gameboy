...
fn disassemble_unprefixed(mmu: &Mmu, pos: u16) {
    match mmu.read(pos) {
        0x00 => println!("NOP"),
        0x01 => println!("LD BC, {:#04x}", mmu.read16(pos + 1)),
        0x02 => println!("LD (BC), A"),
        0x03 => println!("INC BC"),
        0x04 => println!("INC B"),
        0x05 => println!("DEC B"),
        0x06 => println!("LD B, {:#02x}", mmu.read(pos + 1)),
        0x07 => println!("RLCA"),
        0x08 => println!("LD ({:#04x}), SP", mmu.read16(pos + 1)),
        0x09 => println!("ADD HL, BC"),
        0x0A => println!("LD A, (BC)"),
        0x0B => println!("DEC BC"),
        0x0C => println!("INC C"),
        0x0D => println!("DEC C"),
        0x0E => println!("LD C, {:#02x}", mmu.read(pos + 1)),
        0x0F => println!("RRCA"),
        0x10 => println!("STOP {:#02x}", mmu.read(pos + 1)),
        0x11 => println!("LD DE, {:#04x}", mmu.read16(pos + 1)),
        0x12 => println!("LD (DE), A"),
        0x13 => println!("INC DE"),
        0x14 => println!("INC D"),
        0x15 => println!("DEC D"),
        0x16 => println!("LD D, {:#02x}", mmu.read(pos + 1)),
        0x17 => println!("RLA"),
        0x18 => println!("JR + {}", mmu.read(pos + 1) as i8),
        0x19 => println!("ADD HL, DE"),
        0x1A => println!("LD A, (DE)"),
        0x1B => println!("DEC DE"),
        0x1C => println!("INC E"),
        0x1D => println!("DEC E"),
        0x1E => println!("LD E, {:#02x}", mmu.read(pos + 1)),
        0x1F => println!("RRA"),
        0x20 => println!("JR NZ + {}", mmu.read(pos + 1) as i8),
        0x21 => println!("LD HL, {:#04x}", mmu.read16(pos + 1)),
        0x22 => println!("LD (HL+), A"),
        0x23 => println!("INC HL"),
        0x24 => println!("INC H"),
        0x25 => println!("DEC H"),
        0x26 => println!("LD H, {:#02x}", mmu.read(pos + 1)),
        0x27 => println!("DAA"),
        0x28 => println!("JR Z + {}", mmu.read(pos + 1) as i8),
        0x29 => println!("ADD HL, HL"),
        0x2A => println!("LD A, (HL+)"),
        0x2B => println!("DEC HL"),
        0x2C => println!("INC L"),
        0x2D => println!("DEC L"),
        0x2E => println!("LD L, {:#02x}", mmu.read(pos + 1)),
        0x2F => println!("CPL"),
        0x30 => println!("JR NC + {}", mmu.read(pos + 1) as i8),
        0x31 => println!("LD SP, {:#04x}", mmu.read16(pos + 1)),
        0x32 => println!("LD (HL-), A"),
        0x33 => println!("INC SP"),
        0x34 => println!("INC (HL)"),
        0x35 => println!("DEC (HL)"),
        0x36 => println!("LD (HL), {:#02x}", mmu.read(pos + 1)),
        0x37 => println!("SCF"),
        0x38 => println!("JR C + {}", mmu.read(pos + 1) as i8),
        0x39 => println!("ADD HL, SP"),
        0x3A => println!("LD A, (HL-)"),
        0x3B => println!("DEC SP"),
        0x3C => println!("INC A"),
        0x3D => println!("DEC A"),
        0x3E => println!("LD A, {:#02x}", mmu.read(pos + 1)),
        0x3F => println!("CCF"),
        0x40 => println!("LD B, B"),
        0x41 => println!("LD B, C"),
        0x42 => println!("LD B, D"),
        ...
        0xC0 => println!("RET NZ"),
        0xC1 => println!("POP BC"),
        0xC2 => println!("JP NZ, {:#04x}", mmu.read16(pos + 1)),
        0xC3 => println!("JP {:#04x}", mmu.read16(pos + 1)),
        0xC4 => println!("CALL NZ, {:#04x}", mmu.read16(pos + 1)),
        0xC5 => println!("PUSH BC"),
        0xC6 => println!("ADD A, {:#02x}", mmu.read(pos + 1)),
        0xC7 => println!("RST 00"),
        0xC8 => println!("RET Z"),
        0xC9 => println!("RET"),
        0xCA => println!("JP Z, {:#04x}", mmu.read16(pos + 1)),
        0xCB => println!("PREFIX"),
        0xCC => println!("CALL Z, {:#04x}", mmu.read16(pos + 1)),
        0xCD => println!("CALL {:#04x}", mmu.read16(pos + 1)),
        0xCE => println!("ADC A, {:#02x}", mmu.read(pos + 1)),
        0xCF => println!("RST 08"),
        0xD0 => println!("RET NC"),
        0xD1 => println!("POP DE"),
        0xD2 => println!("JP NC, {:#04x}", mmu.read16(pos + 1)),
        0xD3 => println!("ILLEGAL_D3"),
        0xD4 => println!("CALL NC, {:#04x}", mmu.read16(pos + 1)),
        0xD5 => println!("PUSH DE"),
        0xD6 => println!("SUB {:#02x}", mmu.read(pos + 1)),
        0xD7 => println!("RST 10"),
        0xD8 => println!("RET C"),
        0xD9 => println!("RETI"),
        0xDA => println!("JP C, {:#04x}", mmu.read16(pos + 1)),
        0xDB => println!("ILLEGAL_DB"),
        0xDC => println!("CALL C, {:#04x}", mmu.read16(pos + 1)),
        0xDD => println!("ILLEGAL_DD"),
        0xDE => println!("SBC A, {:#02x}", mmu.read(pos + 1)),
        0xDF => println!("RST 18"),
        0xE0 => println!("LD (0xff00 + {:#02x}), A", mmu.read(pos + 1)),
        0xE1 => println!("POP HL"),
        0xE2 => println!("LD (0xff00 + C), A"),
        0xE3 => println!("ILLEGAL_E3"),
        0xE4 => println!("ILLEGAL_E4"),
        0xE5 => println!("PUSH HL"),
        0xE6 => println!("AND {:#02x}", mmu.read(pos + 1)),
        0xE7 => println!("RST 20"),
        0xE8 => println!("ADD SP + {}", mmu.read(pos + 1) as i8),
        0xE9 => println!("JP HL"),
        0xEA => println!("LD ({:#04x}), A", mmu.read16(pos + 1)),
        0xEB => println!("ILLEGAL_EB"),
        0xEC => println!("ILLEGAL_EC"),
        0xED => println!("ILLEGAL_ED"),
        0xEE => println!("XOR {:#02x}", mmu.read(pos + 1)),
        0xEF => println!("RST 28"),
        0xF0 => println!("LD A, (0xff00 + {:#02x})", mmu.read(pos + 1)),
        0xF1 => println!("POP AF"),
        0xF2 => println!("LD A, (0xff00 + C)"),
        0xF3 => println!("DI"),
        0xF4 => println!("ILLEGAL_F4"),
        0xF5 => println!("PUSH AF"),
        0xF6 => println!("OR {:#02x}", mmu.read(pos + 1)),
        0xF7 => println!("RST 30"),
        0xF8 => println!("LD HL, SP + {}", mmu.read(pos + 1) as i8),
        0xF9 => println!("LD SP, HL"),
        0xFA => println!("LD A, ({:#04x})", mmu.read16(pos + 1)),
        0xFB => println!("EI"),
        0xFC => println!("ILLEGAL_FC"),
        0xFD => println!("ILLEGAL_FD"),
        0xFE => println!("CP {:#02x}", mmu.read(pos + 1)),
        0xFF => println!("RST 38"),
    }
}
